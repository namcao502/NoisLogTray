...
// Reads the key from the project .env so no secret is hardcoded.
...
var apiKey = ReadEnvValue(EnvPath, "HRM_API_KEY");
...
try
{
    ...
    Console.WriteLine("\nlog_timesheet input schema:");
    Console.WriteLine(JsonSerializer.Serialize(logTool.JsonSchema, new JsonSerializerOptions { WriteIndented = true }));
